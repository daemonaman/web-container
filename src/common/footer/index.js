        ...
        <div className="footer-links-number-container">
          <div className="footer-contact-quicklinks">
            ...
            <div className="footer-content">
              mio2022[at]investodisha[dot]org
            </div>
          </div>
          <div className="footer-contact-quicklinks">
            <div className="footer-heading">Quick Links</div>
            <a
              href="http://www.msmeodisha.gov.in/"
              style={{ textDecoration: "none" }}
            >
              {" "}
              <div className="footer-content">MSME</div>
            </a>
            <a
            ...
            >
              {" "}
              <div className="footer-content">Startup Odisha</div>
            </a>
            <a
              href="https://investodisha.gov.in/"
              style={{ textDecoration: "none" }}
            >
              <div className="footer-content">Invest Odisha</div>
            </a>
            <a
              href="http://www.odisha.gov.in/"
              style={{ textDecoration: "none" }}
            >
              <div className="footer-content">Government of Odisha</div>
            </a>
            <a
              href="https://odishatourism.gov.in/"
              style={{ textDecoration: "none" }}
            >
              <div className="footer-content">Odisha Tourism</div>
            </a>
          </div>
        </div>
        <div className="footer-copyright">
          Invest Odisha © 2022, All Rights Reserved
        </div>
      </div>
    );
  }
